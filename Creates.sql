...
(
	...
	DATE_RESERVATION	DATE			NOT NULL, --À rajouter : DEFAULT GETDATE()
...
(
	...
	CONSTRAINT FK1_ID_AVION
					FOREIGN KEY (ID_AVION)
					REFERENCES AVION (ID_AVION),
	CONSTRAINT FK2_ID_PILOTE
					FOREIGN KEY (ID_PILOTE)
					REFERENCES PILOTE (ID_PILOTE),
	CONSTRAINT FK3_ID_SEGMENT
...
(
	...
	CONSTRAINT FK1_ID_RESERVATION
					FOREIGN KEY(ID_RESERVATION)
					REFERENCES RESERVATION (ID_RESERVATION),
	CONSTRAINT FK2_ID_ENVOLEE
