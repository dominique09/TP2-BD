...
CREATE OR REPLACE
	FUNCTION GET_NUMBER_OF_AVAILABLE_PLACE(P_ID_VOL IN NUMERIC, P_DATE_VOL IN VARCHAR2) RETURN NUMERIC
AS
	V_OCCUPIED NUMERIC;
	V_AVAILABLE NUMERIC;
BEGIN
...
SELECT GET_NUMBER_OF_AVAILABLE_PLACE(2, '14-05-2015') FROM DUAL;
